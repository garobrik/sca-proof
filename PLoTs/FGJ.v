...
| Cast_E_Ty_Trans : forall XNs Us e e', 
  Generic_Cast.E_Ty_Trans _ _ _ _ _ _ Cast_E (GJ_TE_Trans _ _ Ty_trans _) E_Ty_Trans XNs Us e e' ->
...
| Cast_E_WF : forall gamma e ty, 
  Cast.Cast_E_WF _ _ _ (Generic.FJ_Ty_Wrap Ty ty_ext nat N Base_Ty id) _ _ Cast_E E_WF Bound subtype gamma e ty ->
  E_WF gamma e ty.
...
| Cast_Reduce : forall e e', 
  Cast.Cast_Reduce _ _ _ (Generic.FJ_Ty_Wrap Ty ty_ext nat N Base_Ty id) 
  _ _ Cast_E subtype nat nat nat m_call_ext Base_E Empty e e' ->
  Reduce e e'
...
Section WF_Proofs.
  ...
  Fixpoint Weakening gamma e ty (WF_e : E_WF gamma e ty) : Weakening_def _ _ _ WF_e :=
    match WF_e return Weakening_def _ _ _ WF_e with
      | FJ_E_WF gamma e ty FJ_case => FJ_Weakening _ _ _ _ _ _ _ _ _ Base_E _ _
        ...
        FJ_case Weakening
      | Cast_E_WF gamma e ty Cast_case => Cast_Weakening _ _ _ (Generic.FJ_Ty_Wrap Ty ty_ext nat N Base_Ty id) _ _ Cast_E
        E_WF Bound subtype Cast_E_WF _ _ _ _ _ CT build_te Empty Update Base_sub
  ...
  Lemma FJ_fields_build_tys_tot : forall ce te (tys : list Ty) te' te'',
    FJ_build_te ce te te' te'' ->
    exists tys' : list Ty, FJ_fields_build_tys Ty te ce tys tys'.
  ...
  Fixpoint Weakening_2_1_3_1 delta e T (WF_e : E_WF delta e T) :
    ...
    match WF_e in E_WF delta e T return Generic.Weakening_2_1_3_1_P _ _ app_context _ E_WF delta e T WF_e with 
      ...
      | Cast_E_WF gamma e ty Cast_case => Generic_Cast.Weakening_2_1_3_1 _ _ _ _ _ _ _ _ N_Wrap 
        id Cast_E _ app_context
        E_WF Bound subtype Cast_E_WF WF_Bound_app_Weaken' Weakening_2_1_1 subtype_dec Ty_eq_dec _ _ CT
        build_te Base_sub gamma e ty Cast_case Weakening_2_1_3_1
    end.
  ...
  Lemma Ty_trans_FJ : forall ty Xs Us, Ty_trans (Base_Ty ty) Xs Us = 
  ...
  Lemma L_WF_bound : forall cld : cFJ.L _ _ _ _ ty_ext Ty E md_ext cld_ext,
    L_WF cld ->
  ...
  Lemma FJ_Ty_rename_invert : forall (ty : cFJ.FJ_Ty nat ty_ext) Y,
    Ty_rename (Base_Ty ty) Y =
    FJ_Ty_rename _ Ty ty_ext nat N (Generic.FJ_Ty_Wrap Ty ty_ext nat N Base_Ty id) id TE_rename ty Y.
    reflexivity.
  Qed.
  ...
  Fixpoint subtype_update_Tupdate delta S T (sub_S_T : subtype delta S T) :=
    ...
    match WF_e in E_WF gamma e T return Generic.Lem_2_11_P _ _ _ _ _ Empty subtype Ty_trans WF_Type _ 
      ...
      | Cast_E_WF gamma e ty Cast_case => Generic_Cast.Cast_Lem_2_11 _ _ _ _ _ _ _ _     
        _ (Generic.FJ_Ty_Wrap Ty ty_ext nat N Base_Ty id) id Ty_trans Cast_E TE_trans
        _ app_context E_WF Bound subtype Cast_E_WF subtype_dec 
        Ty_eq_dec _ _ CT build_te Base_sub Update E_Ty_Trans TUpdate
  ...
  Definition Build_S0''' : forall (ce : cld_ext) (me : md_ext)
                 ...
                 Meth_build_context ce me
                   (cFJ.update_list _ Ty Context Update Empty
                      ((this _,
                        Generic.FJ_Ty_Wrap Ty ty_ext _ N N_Wrap id
                 ...
                 exists S0'' : Ty,
                   ...
                   E_WF (cFJ.update_list _ Ty Context Update delta Vars) e'
                     S0'' := Generic.GJ_Build_S0''' _ _ _ Gty _ _ (Generic.FJ_Ty_Wrap Ty ty_ext _ N N_Wrap id) id
  ...
  Fixpoint Subtype_Update_list_id'' gamma S T (sub_S_T : subtype gamma S T) :=
    match sub_S_T in (subtype gamma S T) return 
      ...
      | Base_sub gamma' S' T' sub_S_T' => 
        ...
        build_te Update Base_sub gamma' S' T' sub_S_T' Subtype_Update_list_id''
      | GJ_sub gamma' S' T' sub_S_T' => 
        Generic_Cast.Subtype_Update_list_id' _ _ _ _ (Generic.FJ_Ty_Wrap Ty ty_ext nat N Base_Ty id)
  ...
  Fixpoint Term_subst_pres_typ gamma e T (WF_e : E_WF gamma e T) :
    ...
    match WF_e with 
      | Cast_E_WF gamma e ty Cast_case => Cast_Term_subst_pres_typ _ _ _ _
        ...
        Base_sub subtype_dec Ty_eq_dec trans Cast_E_trans_Wrap 
        Subtype_Update_list_id Subtype_Update_list_id''
        WF_mtype_ty_0_map_Weaken_update_list WF_mtype_ty_0_map_total sub_Bound _ _ _ Cast_case Term_subst_pres_typ
  ...
  Definition WF_fields_map_sub' := 
    ...
    Lemma Cast_E_WF_invert : forall gamma e c0, E_WF gamma (Cast_E e) c0 -> 
      Cast.Cast_E_WF _ _ _  (Generic.FJ_Ty_Wrap Ty ty_ext nat N Base_Ty id) _ _ 
  ...
  Fixpoint preservation e e' (red_e : Reduce e e') : preservation_def _ _ red_e :=
    match red_e with 
      | Cast_Reduce e e' cast_red_e => Cast_preservation' _ _ _ 
        (Generic.FJ_Ty_Wrap Ty ty_ext nat N Base_Ty id) _ _ Cast_E
        E_WF Bound subtype Reduce _ _ _ _ _ _ Base_E CT build_te Empty Cast_Reduce 
        Base_sub Cast_E_WF_invert Cast_E_inject FJ_E_WF_new_invert
      ...
      | Cast_C_Reduce e e' cast_c_red_e => Cast_C_preservation' _ _ _ _ _ _ Cast_E
        ...
        Base_sub subtype_dec Ty_eq_dec WF_mtype_ty_0_map_total sub_Bound Cast_E_WF_invert Cast_E_inject
      ...
      |  FJ_S_Reduce t t' red_t => FJ_pres _ _ _ _ _ _ _ _ _ 
        ...
        WF_fields_map_sub' Subtype_Weaken WF_mtype_map_sub Term_subst_pres_typ _ Lem_2_12
        t t' red_t
  ...
  Inductive subexpression : E -> E -> Prop :=
   | FJ_subexpression_Wrap : forall e e', 
     FJ_subexpression _ _ _ _ _ _ _ Base_E subexpression subexpression_list e e' -> subexpression e e'
  ...
  Lemma FJ_Cast_discriminate : forall (e : FJ_E _ _ _ _ ty_ext E m_call_ext)
    (S : cFJ.FJ_Ty _ ty_ext) (e' : E), Base_E e <> Cast_E (cast _ ty_ext E S e').
    congruence.
  Qed.
  ...
  Fixpoint progress_1 gamma e T (WF_e : E_WF gamma e T) :
    ...
    match WF_e with 
      | Cast_E_WF gamma e ty Cast_case => Cast_progress_1 _ _ _ _
        _ _ Cast_E E_WF Bound subtype Cast_E_WF _ _ _ _ Base_E Empty Cast_E_inject fields 
  ...
  Fixpoint progress_2 gamma e T (WF_e : E_WF gamma e T) :
    ...
    match WF_e with 
      ...
      | Cast_E_WF gamma e ty Cast_case => Cast_progress_2 _ _ _ _
        _ _ Cast_E E_WF Bound subtype Cast_E_WF _ _ _ _ _ _ Base_E CT Empty Cast_E_inject  
