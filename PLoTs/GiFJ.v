...
| GJ_sub : forall gamma ty ty', GJ_subtype _ _ Gty N N_Wrap _
...
| FJ_S_Reduce : forall e e', FJ_Reduce _ _ _ _ _ _  (Generic.FJ_Ty_Wrap Ty ty_ext nat N N_Wrap cFJ_N) _ _
  cFJ_E _ _ CT _ fields mbody_build_te mb_ext build_mb_ext map_mbody
...
Lemma L_WF_bound : forall cld : cFJ.L nat nat nat nat ty_ext Ty E md_ext cld_ext,
  ...
  Lemma Ty_Wrap_discriminate' : forall (ty : FJ_Ty ty_ext _) (ty' : I_Ty _ ty_ext),
    Generic_Interface.FJ_Ty_Wrap _ Ty ty_ext N N_Wrap
